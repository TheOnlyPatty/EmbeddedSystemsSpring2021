            ...
            while (TRUE) {
                if (esos_uiF14_isSW3Pressed()) {
                    ...
                    break;
                           ...
                           esos_uiF14_getRPGValue_u16() > 750 && !b_lastMenu) {
                    ...
                    ESOS_TASK_WAIT_UNTIL(esos_uiF14_getRPGValue_u16() < 750);
                    break;
                } else if (esos_uiF14_isRPGTurning() && esos_uiF14_isRPGTurningCCW() &&
                           esos_uiF14_getRPGValue_u16() < -750 && !b_firstMenu) {
                    u8_current = pst_menu->u8_choice;
                    --pst_menu->u8_choice;
                    // if its hidden don't show the menu
                    while (pst_menu->ast_items[pst_menu->u8_choice].b_hidden == 1) {
            ...
            if (u8_idlen2 > 0 && FALSE) {
                ...
                while (TRUE) {
                    if (esos_uiF14_isSW3Pressed()) {
                        ...
                        __esos_menu_conf.e_menutype = NONE;
                        break;
                    } else if (esos_uiF14_getRPGValue_u16() <= -1) {
            ...
            while (TRUE) {
                ...
                if (pst_menu->type == 0) {
                    ...
                    default:
                        break;
                    case 0x01:
                        u8_barBottom = char_BAR1;
                    case 0x02:
                        u8_barBottom = char_BAR2;
                        break;
                    case 0x03:
                        u8_barBottom = char_BAR3;
                        break;
                    case 0x04:
                        u8_barBottom = char_BAR4;
                        break;
                    case 0x05:
                        u8_barBottom = char_BAR5;
                        break;
                    case 0x06:
                        u8_barBottom = char_BAR6;
                        break;
                    case 0x07:
                        u8_barBottom = char_BAR7;
                        break;
                    case 0x08:
                        u8_barBottom = char_BAR8;
                        break;
                    case 0x09:
                        u8_barTop = char_BAR1;
                        u8_barBottom = char_BAR8;
