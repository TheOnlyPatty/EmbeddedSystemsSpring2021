...
ESOS_USER_TASK(interface)
{
	...
	while (TRUE) {
		...
		//SW1
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW1DoublePressedPeriod(u16_sw1_period_val + 50);
				break;
			case "2":
				esos_uiF14_setSW1DoublePressedPeriod(u16_sw1_period_val - 50);
				break;
		...
		//SW2
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW2DoublePressedPeriod(u16_sw2_period_val + 50);
				break;
			case "2":
				esos_uiF14_setSW1DoublePressedPeriod(u16_sw2_period_val - 50);
				break;
			case '3':
				MENU_STATE = BASE;
				break;
		...
		//SW3
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW3DoublePressedPeriod(u16_sw3_period_val + 50);
				break;
			case "2":
				esos_uiF14_setSW3DoublePressedPeriod(u16_sw3_period_val - 50);
				break;
		...
		//RPG SLOW
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_slow_val + 40);
				break;
			case "2":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_slow_val - 40);
				break;
		...
		//RPG MED
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_med_val + 15);
				break;
			case "2":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_med_val - 15);
				break;
		...
		//RPG FAST
			...
			switch (u8_input) {
			case "1":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_fast_val + 1);
				break;
			case "2":
				esos_uiF14_setSW1DoublePressedPeriod(i16_rpg_fast_val - 1);
				break;
